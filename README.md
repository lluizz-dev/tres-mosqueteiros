...
Jogo de tabuleiro para dois jogadores desenvolvido com HTML, CSS e JavaScript puro.
...
Projeto desenvolvido como atividade da disciplina **Desenvolvimento Web 2** do curso de Tecnologia em Análise e Desenvolvimento de Sistemas no IFPE.